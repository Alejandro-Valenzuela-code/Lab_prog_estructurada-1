...
def encontrar_solucion(tablero, contador, candidato, MAX, x, y, xsiguiente, ysiguiente, modo_soluciones, soluciones, camino):
...
def main():
    ...
    mostrar_tablero(tablero, MAX)
    modo_soluciones = elegir_modo()
    tablero[x][y] = 1
    encontrar_solucion(tablero, contador, candidato, MAX, x, y, xsiguiente, ysiguiente, modo_soluciones, soluciones, [(0, 0)])
